...
const Menu = ({ navigation, route }) => {
  ...
  const loadMenu = useCallback(async () => {
    ...
    try {
      await dispatch(fetchMenuByServiceProvider(serviceProvider));
    } catch (err) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View
          style={{ height: 100, width: 1, backgroundColor: "#F7941D" }}
        ></View>
        <View>
          <Image
      ...
      <FlatList
        ...
        renderItem={({ item }) => <MenuItem data={item} navigation={navigation}/>}
      />
    </SafeAreaView>
  );
};
