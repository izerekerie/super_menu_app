      ...
      <View style={styles.header}>
            ...
            <View style={styles.headerContentContainer}>
                    <View style={styles.headerContentContainer}>
                        ...
                        <Image source={require('../assets/One_credit_card.png')}  style={styles.cardStyle}/>
                    </View>
                    <View >
                        <Text style={[styles.bigText,{color:'#25d482'}]}>Frw 16,000</Text>
                        <Text style={{color:'#ccc' }}>Including VAT (18%)</Text>
                    </View>
            </View>
      </View>
      <View style={{flexDirection:'row',justifyContent:'space-between',backgroundColor:'#25d482',borderRadius:10,width:'90%',alignSelf:'center',height:40,alignItems:'center',position:'absolute',marginTop:'40%'}}>
          <View style={{borderRadius:10, backgroundColor:'#fff',width:'50%',height:55,alignItems:'center',justifyContent:'center',shadowColor: "#000",
shadowOffset: {
	width: 0,
	height: 1,
},
...
elevation: 3,}}>
          ...
          <Text style={{color:'#fff',fontWeight:'bold'}}>Mobile & Cash</Text>
          </View>
...
elevation: 15,
      ...
      backContainer:{backgroundColor:'#f8f8fb', width:40, alignItems:"center", borderRadius:5},
